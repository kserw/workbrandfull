...
export default function ResultTabs({
  ...
  return (
    <div className="relative">
      ...
      {isLoading && (
        <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-t from-[#2F3295]/95 to-transparent backdrop-blur-sm p-4 z-50">
          <div className="max-w-7xl mx-auto flex items-center justify-center space-x-4">
            <div className="w-6 h-6 border-4 border-[#FE619E]/30 border-t-[#FE619E] rounded-full animate-spin"></div>
            <span className="text-white font-medium">Processing your comparison...</span>
          </div>
        </div>
      )}
    </div>
